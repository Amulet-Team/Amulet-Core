...
class BoxTestCase(unittest.TestCase):
    def test_intersects(self):
        box_1 = selection.SubSelectionBox((0, 0, 0), (5, 5, 5))
        box_2 = selection.SubSelectionBox((4, 4, 4), (10, 10, 10))

        self.assertTrue(box_1.intersects(box_2))
        self.assertTrue(box_2.intersects(box_1))

        box_3 = selection.SubSelectionBox((5, 5, 5), (10, 10, 10))

        self.assertFalse(box_1.intersects(box_3))
        self.assertFalse(box_3.intersects(box_1))

        box_4 = selection.SubSelectionBox((1, 20, 1), (4, 25, 4))
    ...
    def test_add_box(self):  # Quick crude test, needs more cases
        ...
        box_1.add_box(selection.SubSelectionBox((0, 5, 0), (5, 10, 5)))
        self.assertEqual(1, len(box_1))
        box_1.add_box(selection.SubSelectionBox((0, 10, 0), (5, 15, 5)))
        self.assertEqual(1, len(box_1))

        box_2 = selection.Selection((sub_box_1,))
        self.assertEqual(1, len(box_2))
        box_2.add_box(selection.SubSelectionBox((0, 6, 0), (5, 10, 5)))
        self.assertEqual(2, len(box_2))

        box_3 = selection.Selection((sub_box_1,))
        self.assertEqual(1, len(box_3))
        box_3.add_box(selection.SubSelectionBox((0, 10, 0), (5, 15, 5)))
        self.assertEqual(2, len(box_3))
        box_3.add_box(selection.SubSelectionBox((0, 5, 0), (5, 10, 5)))
        self.assertEqual(1, len(box_3))

    def test_single_block_box(self):
        sub_box_1 = selection.SubSelectionBox((0, 0, 0), (1, 1, 2))
        box_1 = selection.Selection((sub_box_1,))
    ...
    def test_sorted_iterator(self):
        sub_box_1 = selection.SubSelectionBox((0, 0, 0), (4, 4, 4))
        box_1 = selection.Selection((sub_box_1,))
        box_2 = selection.Selection((sub_box_1,))

        sub_box_2 = selection.SubSelectionBox((7, 7, 7), (10, 10, 10))
        box_1.add_box(sub_box_2)

        sub_box_3 = selection.SubSelectionBox((15, 15, 15), (20, 20, 20))
