...
class NBTTemplateTestBase:
    ...
    def test_any_tag(self):  # Reminder test since any tags aren't supported yet!
        ...
        template.apply_to(mock_1)
        template.apply_to(mock_2)
        template.apply_to(mock_3)
        template.apply_to(mock_4)

        self.assertEqual(mock_1["any_tag"], NBTEntry("string", "string_test"))
        self.assertEqual(mock_2["any_tag"], NBTEntry("int", "int_test"))
        self.assertEqual(
            mock_3["any_tag"],
    ...
    def test_item_apply_template(self):
        ...
        item_template.apply_to(mock_item_1)
        ...
        item_template.apply_to(mock_item_2)
        ...
        item_template.apply_to(mock_item_3)
        ...
        item_template.apply_to(mock_item_4)
        ...
        item_template.apply_to(mock_item_5)
        self.assertEqual(mock_item_5_expected, mock_item_5)


# noinspection PyUnresolvedReferences
class NBTTemplateTestBase2:
    """
...
class Java113NBTTemplateTestCase2(NBTTemplateTestBase2, unittest.TestCase):
    def setUp(self):
        self._setUp(
            os.path.join(
                os.path.dirname(TESTS_DIR), "src", "version_definitions", "java_1_13"
