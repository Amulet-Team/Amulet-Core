...
latex_documents = [
    (master_doc, 'UnifiedMapEditor.tex', 'Unified Map Editor Documentation',
     'The Unified Map Editor Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'unifiedmapeditor', 'Unified Map Editor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'UnifiedMapEditor', 'Unified Map Editor Documentation',
     author, 'UnifiedMapEditor', 'One line description of project.',
     'Miscellaneous'),
]
