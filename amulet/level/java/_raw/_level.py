...
from ._dimension_ import JavaRawDimension
...
class JavaRawLevelOpenData:
    ...
    def __init__(
        self, lock_file: BinaryIO, lock_time: float, data_pack: DataPackManager
    ) -> None:
...
class JavaRawLevel(RawLevel[JavaRawDimension]):
    ...
    def open(self) -> None:
        ...
        packs = []
        enabled_packs = (
            self.level_dat.compound.get_compound("Data")
        ...
        self._raw_open_data = JavaRawLevelOpenData(lock_file, lock_time)
        self.opened.emit()
    ...
    def _register_dimension(
        ...
        if (
            ...
            self._o.dimensions[relative_dimension_path] = DimensionEntry(
