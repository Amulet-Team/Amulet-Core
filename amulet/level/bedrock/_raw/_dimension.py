...
class BedrockRawDimension(
    ...
    def default_block(self) -> BlockStack:
        ...
        return BlockStack(Block(self._r.max_game_version, "minecraft", "air"))

    def default_biome(self) -> Biome:
        """The default biome for this dimension"""
        # todo: is this stored in the data somewhere?
        if self.dimension == THE_NETHER:
            return Biome(self._r.max_game_version, "minecraft", "nether")
        elif self.dimension == THE_END:
            return Biome(self._r.max_game_version, "minecraft", "the_end")
        else:
            return Biome(self._r.max_game_version, "minecraft", "plains")
