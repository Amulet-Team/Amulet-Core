...
parser = argparse.ArgumentParser(description="Generate all interfaces up to a given level.")
parser.add_argument("interfaceversion", type=int, help="Generate all interfaces up to this level.")
...
class LevelDB{i}Interface(ParentInterface):
    def __init__(self):
        ...
        self._set_feature("chunk_version", {i})
