...
class DataPackManager:
    ...
    def __init__(self, data_packs: Iterable[DataPack]):
        ...
        """
        self._data_packs = reversed(tuple(pack for pack in data_packs if isinstance(pack, DataPack) and pack.is_valid))
    ...
    def open(self, relative_path: str) -> BinaryIO:
        ...
        raise FileNotFoundError(f"The requested path {relative_path} could not be found.")
