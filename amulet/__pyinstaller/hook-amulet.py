...
hiddenimports = [
    ...
    name for _, name, _ in pkgutil.walk_packages(operations.__path__, operations.__name__ + ".")
] + [
    "amulet.api.structure"
]

datas = collect_data_files("PyMCTranslate", excludes=["__pyinstaller", "json", "*.pyc", "*.py", "*.dll", "*.so", "*.dylib"])
