...
class SpongeSchemInterface(Interface):
    ...
    def decode(self, cx: int, cz: int, data: SpongeSchemChunk) -> Tuple['Chunk', AnyNDArray]:
        """
        ...
        """
    def encode(self, chunk: Chunk, palette: AnyNDArray, max_world_version: VersionIdentifierType, box: SelectionBox) -> SpongeSchemChunk:
        """
        ...
        """
    def get_translator(self, max_world_version: Tuple[str, int], data: Any = ..., translation_manager: TranslationManager = ...) -> Tuple['Translator', VersionNumberAny]: ...
