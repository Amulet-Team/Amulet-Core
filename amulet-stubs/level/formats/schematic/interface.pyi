...
class SchematicInterface(Interface):
    ...
    def decode(self, cx: int, cz: int, data: SchematicChunk) -> Tuple['Chunk', AnyNDArray]:
        """
        ...
        """
    def encode(self, chunk: Chunk, palette: AnyNDArray, max_world_version: VersionIdentifierType, box: SelectionBox) -> SchematicChunk:
        """
