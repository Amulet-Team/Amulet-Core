...
SECTOR_BYTES: int
SECTOR_INTS: Incomplete
CHUNK_HEADER_SIZE: int
VERSION_GZIP: int
VERSION_DEFLATE: int

def block_coords_to_chunk_coords(*args: int, sub_chunk_size: int = ...) -> Tuple[int, ...]:
    """
    ...
    """
def chunk_coords_to_block_coords(x: int, z: int, chunk_x_size: int = ..., chunk_z_size: int = ...) -> ChunkCoordinates:
    """
...
def to_nibble_array(arr: ndarray) -> ndarray:
    ...
    """
def decode_long_array(long_array: numpy.ndarray, size: int, bits_per_entry: int, dense: bool = ..., signed: bool = ...) -> numpy.ndarray:
    """
    ...
    """
def encode_long_array(array: numpy.ndarray, bits_per_entry: Optional[int] = ..., dense: bool = ..., min_bits_per_entry: int = ...) -> numpy.ndarray:
    """
    ...
    """
def get_size(obj, seen: Incomplete | None = ...):
    """Recursively finds size of objects"""
def get_smallest_dtype(arr: ndarray, uint: bool = ...) -> int:
    """
    ...
    """
def entity_position_to_chunk_coordinates(entity_coordinates: Tuple[float, float, float]): ...
