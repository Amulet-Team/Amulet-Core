...
class Fill(Operation):
    ...
    def run_operation(self, world):
        ...
        if isinstance(self.fill_block, str):
            self.fill_block = numpy.where(world.block_definitions == self.fill_block)[0][0]
        ...
        for target in self.target_box.subboxes():
            ...
            for selection in block_generator:
                ...
                selection.blocks = numpy.full(selection.blocks.shape, self.fill_block, selection.blocks.dtype)