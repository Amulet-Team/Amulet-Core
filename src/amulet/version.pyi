...
import typing
__all__ = ['PlatformType', 'PlatformVersionContainer', 'VersionNumber', 'VersionRange', 'VersionRangeContainer']
...
class VersionNumber:
    ...
    def cropped_version(self) -> tuple:
        ...
        """
    def index(self, value: int, start: int = 0, stop: int = 18446744073709551615) -> int:
        ...
...
class VersionRange:
    def __getstate__(self) -> bytes:
        ...
    def __init__(self, platform: str, min_version: VersionNumber, max_version: VersionNumber) -> None:
        ...
    def __repr__(self) -> str:
        ...
    def __setstate__(self, arg0: bytes) -> None:
