...
class SelectionGroup:
    ...
    def __iter__(self) -> typing.Iterator[amulet.selection.box.SelectionBox]:
        """
    ...
    @typing.overload
    def intersects(self, other: amulet.selection.box.SelectionBox) -> bool:
        """
    ...
    @property
    def bounding_box(self) -> amulet.selection.box.SelectionBox:
        """
