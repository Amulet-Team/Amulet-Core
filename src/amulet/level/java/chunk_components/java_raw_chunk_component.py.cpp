...
void init_java_raw_chunk_component(py::module m)
{
    ...
    JavaRawChunkComponent.def_property(
        "raw_data",
        [](
            Amulet::JavaRawChunkComponent& self) -> pybind11_extensions::collections::abc::MutableMapping<std::string, AmuletNBT::NamedTag> {
        ...
        [](
            Amulet::JavaRawChunkComponent& self, pybind11_extensions::collections::abc::Mapping<std::string, AmuletNBT::NamedTag> py_raw_data) {
