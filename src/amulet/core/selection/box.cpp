...
// Accessors
std::int64_t SelectionBox::min_x() const { return _min_x; }
std::int64_t SelectionBox::min_y() const { return _min_y; }
std::int64_t SelectionBox::min_z() const { return _min_z; }
std::int64_t SelectionBox::max_x() const { return _min_x + _size_x; }
std::int64_t SelectionBox::max_y() const { return _min_y + _size_y; }
std::int64_t SelectionBox::max_z() const { return _min_z + _size_z; }
std::array<std::int64_t, 3> SelectionBox::min() const
{
    return { _min_x, _min_y, _min_z };
}
std::array<std::int64_t, 3> SelectionBox::max() const
{
    return { max_x(), max_y(), max_z() };
}

// Shape and volume
std::uint64_t SelectionBox::size_x() const
{
    return _size_x;
}
std::uint64_t SelectionBox::size_y() const
{
    return _size_y;
}
std::uint64_t SelectionBox::size_z() const
{
    return _size_z;
}
std::array<std::uint64_t, 3> SelectionBox::shape() const
{
    return { _size_x, _size_y, _size_z };
}
size_t SelectionBox::volume() const
{
    return _size_x * _size_y * _size_z;
}
